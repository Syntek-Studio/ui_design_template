...
The `docs/` folder contains comprehensive project documentation, guides, and the self-learning metrics system. All
developer-facing documentation lives here, organised by category.
