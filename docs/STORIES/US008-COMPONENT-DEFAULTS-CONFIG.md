...
Component defaults should be carefully chosen based on design system best practices and common use cases. They should
enable developers to use components without thinking about props in most situations.
