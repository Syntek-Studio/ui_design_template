...
i18n support should be optional and not required for basic usage. The design system should document how to properly
handle translations in consuming applications rather than trying to solve all i18n problems within the component library
itself.
