...
Bundle size is critical for library adoption. All code should be tree-shakeable, and consumers should only pay for what
they use. Regular monitoring and optimisation is important as the library grows.
