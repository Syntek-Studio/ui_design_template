...
The useTheme hook should be lightweight and not require context providers if used directly. For applications using multiple theme hooks, a ThemeProvider wrapper can be created as an optional enhancement.
