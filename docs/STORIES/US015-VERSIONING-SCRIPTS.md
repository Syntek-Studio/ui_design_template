...
Versioning should follow Semantic Versioning 2.0.0 (semver.org) and be automatically determined from conventional
commits. This ensures consistency and enables automation of the release process.
