...
Dark mode should be automatically handled by Tailwind's dark mode support. The main work is defining appropriate colour
values and creating the theme switching hook for applications.
