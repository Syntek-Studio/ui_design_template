...
Utility components should be simple, focused, and reusable. They should follow consistent patterns with other components in the system and integrate seamlessly with the design tokens.
