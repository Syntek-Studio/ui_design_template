...
Documentation should be comprehensive but readable. It should include props reference, usage examples, and accessibility
guidelines. Generated docs should be human-readable and version-controlled.
