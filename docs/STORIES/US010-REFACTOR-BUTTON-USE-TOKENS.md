...
This refactoring is an important milestone that demonstrates the token system working end-to-end. It should be tested
thoroughly to ensure all styles are correct and performance is not impacted.
