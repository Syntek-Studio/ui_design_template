...
Validation should be run automatically before build and can be run manually by developers. The output should be actionable and help designers understand accessibility requirements.
