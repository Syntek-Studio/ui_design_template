...
The template README should be comprehensive yet concise, providing enough information for developers to get started
quickly whilst linking to detailed documentation for deeper dives.
