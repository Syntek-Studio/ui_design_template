...
Input component should handle all common input types and provide clear visual feedback for all states (default, focus,
disabled, error). It should work seamlessly with form validation libraries.
