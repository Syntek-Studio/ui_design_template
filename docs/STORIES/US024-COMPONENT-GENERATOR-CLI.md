...
Component generator should accelerate development and ensure consistency. Templates should be easy to customize for
project-specific needs whilst maintaining established patterns.
