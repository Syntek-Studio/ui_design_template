...
The template package.json should include all necessary scripts for development, building, linting, and testing. It should be a complete, ready-to-use configuration.
