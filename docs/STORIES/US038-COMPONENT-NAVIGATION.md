...
Navigation components should be flexible enough to support common patterns whilst remaining simple for basic usage. They should integrate well with routing libraries like React Router.
