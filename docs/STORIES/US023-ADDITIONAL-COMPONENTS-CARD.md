...
Card component should be simple and flexible, primarily serving as a content container with optional visual styling. It
should support all common use cases: lists of cards, single cards, card groups.
