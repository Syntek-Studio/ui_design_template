...
Vitest is chosen for its speed and ES modules support. Configuration should support both unit tests (isolated
components) and integration tests (component interactions).
